          ...
          <div className="space-y-4">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400">г. Тверь, Авангардная ул., 25А

Заволжский район</p>
                <p className="text-gray-500 dark:text-gray-400">Пн-Пт: 9:00-20:00, Сб-Вс: 10:00-18:00</p>
              </div>
            </div>
          </div>
          <div className="space-y-4">
