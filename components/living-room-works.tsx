...
export default function LivingRoomWorks() {
  ...
  const handlePrev = () => {
    if (selectedImageIndex !== null) {
      setSelectedImageIndex((prevIndex) =>
        prevIndex !== null
          ? (prevIndex - 1 + livingRoomWorks.length) % livingRoomWorks.length
          : null
      );
    }
  };
        ...
        <div className="flex flex-col md:flex-row items-start gap-8 mb-12">
          <div className="w-full md:w-[520px] lg:w-[570px] shrink-0 flex flex-col justify-start">
            <h2 className="text-5xl font-bold mb-4 text-gray-900 dark:text-white leading-tight text-left">
              Мебель для гостиной на
              <br />
              заказ в Твери
            </h2>
            <p className="text-xl text-gray-500 text-left">
              Изготовление мебели для гостиной любой сложности: стенки, горки,
              диваны, журнальные столики. Современный дизайн и качественные
              материалы.
            </p>
          </div>
