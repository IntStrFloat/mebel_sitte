...
const testimonials = [
  ...
  },
  {
    id: 2,
    name: "Сергей Петров",
    location: "Тверь, Московский район",
    rating: 5,
    text: "Купил диван и кресло. Качество отличное, цена приемлемая. Особенно порадовала быстрая доставка по Твери и профессиональная сборка.",
    image: "/ava.png?height=100&width=100",
    date: "02.05.2023",
  },
  {
