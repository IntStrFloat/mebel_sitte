...
export const metadata: Metadata = {
  ...
  description:
    "Производство и продажа мебели на заказ в Твери: кухонные гарнитуры, шкафы-купе, спальни, гостиные. ✓ Бесплатный замер ✓ Рассрочка ✓ Гарантия качества ☎ +7 (915) 722-00-75",
  keywords:
    "мебель Тверь, кухни Тверь, шкафы-купе Тверь, спальни Тверь, мебель на заказ Тверь, кухни на заказ Тверь, мебельная фабрика Тверь, мебельщик Тверь",
  ...
  openGraph: {
    title:
      "Мебельщик Тверь - Качественная мебель на заказ в Твери и Тверской области",
    description:
    ...
    <html lang="ru" suppressHydrationWarning>
      <head>
        ...
        <meta
          ...
          content="mebelshik69@mail.ru"
        />
        <meta
          property="business:contact_data:phone_number"
          content="+7 (915) 722-00-75"
        />
        <meta
          property="business:contact_data:website"
          content="https://mebelhik.ru"
        />
      ...
      <body className={inter.className}>
        ...
        <noscript>
          <div>
            <img
              src="https://mc.yandex.ru/watch/101725436"
